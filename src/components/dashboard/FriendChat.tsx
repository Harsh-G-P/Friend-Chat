      ...
      <div className="border-t border-[#2b2d31] bg-[#313338] p-4 relative">
        <div className="flex items-center gap-2">
          <input
            ...
            className="flex-1 rounded-md bg-[#383a40] text-white px-3 py-2 focus:outline-none"
          />
          <button
        ...
        {showPicker && (
          <div className="absolute bottom-14 left-4 bg-[#2b2d31] border border-gray-700 rounded-md p-2 flex flex-wrap gap-2 shadow-lg z-50 w-[250px] max-h-64 overflow-y-auto">
            {EMOJIS.map(e => (
              <button
                key={e}
